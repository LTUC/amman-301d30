...
// longTask('First One').then(task => {
//   console.log('Task', task)
// }).catch(console.error);

// in our case 
// axios.get(url).then((responose) => {
//   this.setState({ weatherData: responose.data })
// }).catch(error => {
//   alert(error)
// })
...
//   .then(data => { console.log(data); return longTask('c - 4'); }).then(data => { console.log(data); });

// in our case
// axios.get(locationIqUrl).then(res=>{
//   // set the state
//   axios.get(weatherBitUrl).then(weatherREsp => {
